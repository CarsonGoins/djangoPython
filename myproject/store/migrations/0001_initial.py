# Generated by Django 4.0.5 on 2022-07-10 01:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('MEMBERSHIP_BRONZE', 'Bronze'), ('MEMBERSHIP_SILVER', 'Silver'), ('MEMBERSHIP_GOLD', 'Gold')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('PAYMENT_PENDING', 'Pending'), ('PAYMENT_COMPLETE', 'Complete'), ('PAYMENT_FAILED', 'Failed')], default='P', max_length=20)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coll', to='store.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
